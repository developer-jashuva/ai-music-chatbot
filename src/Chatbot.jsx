...
//     try {
//       console.log('going to fetch',input);
...
//       // ✅ Fix: Filter out null values before mapping
//       if (Array.isArray(data.songs) && data.songs.length > 0) {
//         const validSongs = data.songs.filter((song) => song !== null); // Remove null values
